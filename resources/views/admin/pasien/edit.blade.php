        ...
        <form class="forms-sample" action="{{ url('admin/pasien/update', $pasien->id) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama" name="nama"
                            placeholder="Masukkan Nama" value="{{ $pasien->nama }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="gender" name="gender"
                            placeholder="Masukkan Gender" value="{{ $pasien->gender }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_kelurahan" name="nama_kecamatan"
                            placeholder="Masukkan Nama Kelurahan" value="{{ $pasien->nama_kecamatan }}">
                    </div>
                </div>
                <div class="form-group row">
